...
main (void)
{
  ...
  cgi_p_head_http_equiv ("Content-Type", "text/html; charset=iso-8859-1");
  cgi_p_head_meta ("viewport", "width=device-width, initial-scale=1");
  cgi_p_head_title ("View transaction log");
  cgi_p_end_html_head ();

  /* Note: Due to insufficient buffering, many individual standard
     output calls can slow things down.  */
  fputs ("<pre>\n", stdout);
  /* fputs ("<ul>\n", stdout); */
